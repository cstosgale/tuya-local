...
from custom_components.tuya_local_csg.helpers.device_config import TuyaEntityConfig
from custom_components.tuya_local_csg.sensor import TuyaLocalSensor, async_setup_entry
